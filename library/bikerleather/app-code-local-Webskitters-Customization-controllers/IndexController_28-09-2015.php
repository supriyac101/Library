...
class Webskitters_Customization_IndexController extends Mage_Core_Controller_Front_Action
{
	...
	public function reviewAction(){
		...
		$message .='
			<table class="separate">
				...
				<td class="separate-td"><h6 class="revtbhdg">Product Price</h6></td><td class="separate-td">'.number_format($_totpropric, 2, ',', ' ').'</td></tr>';
		...
		$message .='<tr class="grdtot"><td colspan="5" class="separate-td"><h6 class="revtbhdg">Grand Total:</h6></td><td class="separate-td">' .$currency_symbol.' '.number_format($_totpropric, 2, ',', ' ').'</td></tr>';
		$message .='</table>';
	...
	public function sendmailAction(){
		...
		// store currency symbol eg. $
		$currency_symbol = Mage::app()->getLocale()->currency($currency_code)->getSymbol();
		$message .='<tr><td colspan="5">Grand Total:</td><td>' .$currency_symbol.' '.number_format($_totpropric, 2, ',', ' ').'</td></tr>';
		$message .='</table>';
