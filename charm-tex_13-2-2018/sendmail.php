...
if(isset($_POST["send"])){
	...
	$mail->AddReplyTo($email, "John"); //reply-to address
	$mail->SetFrom("jgfunding@jgfunding.com", "JG Funding"); //From address of the mail
	// put your while loop here like below,
	$mail->Subject = "Test AA"; //Subject od your mail
	$mail->AddAddress("rajpal@bitochon.com", "Rajpal"); //To address who will receive this email
	$mail->MsgHTML("Hi,  First SMTP mail has been received. Great Job!.."); //Put your body of the message you can place html code here
