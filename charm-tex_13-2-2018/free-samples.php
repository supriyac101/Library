...
<span class="cradd"><input type="text" size="40" name="add1" required oninvalid="this.setCustomValidity('Please enter address')" onchange="try{setCustomValidity('')}catch(e){}"  value="<?php if($_POST['add1']!=''){echo stripslashes($_POST['add1']); $_POST['add1']='';}?>"><br>
...
<br><p class="frsmprq"><font color="#800000">Samples That You Are Requesting</font> (Style Number &amp; Description )</p>
