...
require_once dirname(__FILE__)."/"."apiVerifier.php";
require_once dirname(__FILE__)."/"."apiLoginTicket.php";
require_once dirname(dirname(__FILE__))."/"."service/apiUtils.php";
