...
require_once dirname(dirname(__FILE__))."/".'io/apiHttpRequest.php';
require_once dirname(dirname(__FILE__))."/".'io/apiCurlIO.php';
require_once dirname(dirname(__FILE__))."/".'io/apiREST.php';
require_once dirname(dirname(__FILE__))."/".'io/apiRPC.php';
