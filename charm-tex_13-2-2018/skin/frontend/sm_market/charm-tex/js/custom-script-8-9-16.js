...
jQuery(document).ready(function () {
	...
	if (jQuery( window ).width() > 770){
		...
		/*jQuery(".tab-one").click(function() {
            ...
            jQuery(".con-one").slideToggle();
            jQuery(".con-two").css("display","none");
            jQuery(".con-three").css("display","none");
            jQuery(".con-four").css("display","none");
            jQuery(".con-five").css("display","none");
            
            jQuery(".tab-two").removeClass('selected');
            jQuery(".tab-three").removeClass('selected');
            jQuery(".tab-four").removeClass('selected');
            jQuery(".tab-five").removeClass('selected');
            jQuery('html, body').animate({scrollTop: jQuery(".tab-one").offset().top}, 2000);
		});
		jQuery(".tab-two").click(function() {
		    jQuery(this).toggleClass("selected");
            jQuery(".con-one").css("display","none");
            jQuery(".con-two").slideToggle();
            jQuery(".con-three").css("display","none");
            jQuery(".con-four").css("display","none");
            jQuery(".con-five").css("display","none");
            
            jQuery(".tab-one").removeClass('selected');
            jQuery(".tab-three").removeClass('selected');
            jQuery(".tab-four").removeClass('selected');
            jQuery(".tab-five").removeClass('selected');
            jQuery('html, body').animate({scrollTop: jQuery(".tab-two").offset().top}, 2000);
        });
		jQuery(".tab-three").click(function() {
		    jQuery(this).toggleClass("selected");
            jQuery(".con-one").css("display","none");
            jQuery(".con-two").css("display","none");
            jQuery(".con-three").slideToggle();
            jQuery(".con-four").css("display","none");
            jQuery(".con-five").css("display","none");
            ...
            jQuery(".tab-four").removeClass('selected');
            jQuery(".tab-five").removeClass('selected');
            jQuery('html, body').animate({scrollTop: jQuery(".tab-three").offset().top}, 2000);
        });
		jQuery(".tab-four").click(function() {
            ...
            jQuery(".tab-three").removeClass('selected');
            jQuery(".tab-five").removeClass('selected');
            jQuery('html, body').animate({scrollTop: jQuery(".tab-four").offset().top}, 2000);
        });
		jQuery(".tab-five").click(function() {
		    jQuery(this).toggleClass("selected");
            jQuery(".con-one").css("display","none");
            jQuery(".con-two").css("display","none");
            jQuery(".con-three").css("display","none");
            jQuery(".con-four").css("display","none");
            jQuery(".con-five").slideToggle();
            
            jQuery(".tab-one").removeClass('selected');
            jQuery(".tab-two").removeClass('selected');
            jQuery(".tab-three").removeClass('selected');
            jQuery(".tab-four").removeClass('selected');
            jQuery('html, body').animate({scrollTop: jQuery(".tab-five").offset().top}, 2000);
        });*/
	}
	jQuery(window).resize(function(){
		if (jQuery( window ).width() > 770){
       ...
       //jQuerey(window).resize(function(){
       //     var windowWidth = jQuery(window).width();
       //     if( windowWidth < 769){
       //          //alert("bellow");
       //          jQuery(".tabHdg ul.resp-tabs-list").addClass("hor_1");
       //          jQuery(".resp-tabs-container").addClass("hor_1");
       //     }else{
       //           //alert("up");
       //           jQuery(".tabHdg ul.resp-tabs-list").removeClass("hor_1");
       //          jQuery(".resp-tabs-container").removeClass("hor_1");
       //     }
       //});
//    
