...
function rotate() {
    ...
    var next = ((current.next().length) ? ((current.next().hasClass('show')) ? jQuery('div.nowShowing ul li:first') : current.next()) :
jQuery('div.nowShowing ul li:first'));
...
jQuery(document).ready(function () {
	...
	jQuery("#owlDemo6, #owlDemo6-mob").owlCarousel({
	...
	jQuery("#owlDemo1, #owlDemo1-mob").owlCarousel({
		//autoPlay: 2000, //Set AutoPlay to 3 seconds
		stagePadding: 50,
		pagination:false,
		navigation : true,
	...
	/*jQuery('#tabs li').click(function(){
		...
		jQuery("#owlDemo3,#owlDemo4,#owlDemo5, #owlDemo5-mob").owlCarousel({
