...
$_SESSION['error']="yes";*/
?>
<form action="/request-catalog?error=yes" method="post" name="form2">
<?php
...
$message="Hi Admin, <br />Below is the Request Catalog information:- <br /><br />";
...
$subject="Request Catalog - $title - Charm-tex.com";
$to='kaily@charm-tex.com';
