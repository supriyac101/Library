    ...
    public function getPdf($orderList = array())
    {
        ...
        foreach ($orderList as $orderModel) {
            ...
            foreach ($orderModel->getAllItems() as $item) {
                ...
                $page->drawLine(255, $startTable,255, $this->y + 12.5);
                $page->drawLine(387, $startTable,387, $this->y + 12.5);
                $page->drawLine(457, $startTable,457,$this->y + 12.5);
                $page->drawLine(515, $startTable,515,$this->y + 12.5);
