...
class Mconnect_Iconlib_Block_Adminhtml_Iconlib_CsvXmlGrid extends Mage_Adminhtml_Block_Widget_Grid
{
  public function __construct()
  {
      parent::__construct();
      $this->setId('iconlibCsvgrid');
  ...
  protected function _prepareColumns()
  {
	  ...
	  $this->addColumn('icon', array(
          'header'    => Mage::helper('iconlib')->__('Icon URL'),
		  'width'     => '150px',
          'align'     =>'left',
          'index'     => 'icon',
      ));	  	  
