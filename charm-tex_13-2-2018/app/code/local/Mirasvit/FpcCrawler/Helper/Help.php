...
class Mirasvit_FpcCrawler_Helper_Help extends Mirasvit_MstCore_Helper_Help
{
    protected $_help = array(
        'system' => array(
            ...
            'extended_crawler_settings_crawler_ignored_pages' => 'List of not allowed for crawler pages (regular expression).<xmp></xmp><b>Can be a regular expression only.</b><br/>Example: /\?[^p][^=]*/',
