...
class Mirasvit_Fpc_Model_Observermf_Sessionmf
{
    ...
    public function onCustomerLogin()
    {
        ...
        // if (isset($_COOKIE['fpc_customer_id'])) {
        //     Mage::getModel('core/cookie')->delete('fpc_customer_id');
        // }
        // Mage::getModel('core/cookie')->set('fpc_customer_id', $customer->getCustomerId(), time() + 3650, '/');
    ...
    public function onCustomerLogout()
    {
        ...
        // if (isset($_COOKIE['fpc_customer_id'])) {
        //     Mage::getModel('core/cookie')->set('fpc_customer_id', 0, time() + 60480000, '/');
        //     Mage::getModel('core/cookie')->delete('fpc_customer_id');
        // }
