...
class Mirasvit_Fpc_Helper_Fpcmf_Mobilemf extends Mage_Core_Helper_Abstract
{
    /**
     * @return bool|string
     */
    public function getMobileDeviceType()
    {
        ...
        if ($config->isMobileDetectEnabled()) {
            $detect = new Mobile_Detect_Extendedmf;
 ...
 * @version     2.8.15
 */
class Mobile_Detect_Extendedmf
{
    /**
