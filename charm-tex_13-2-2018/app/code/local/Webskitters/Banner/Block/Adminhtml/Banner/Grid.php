...
class Webskitters_Banner_Block_Adminhtml_Banner_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  protected function _prepareColumns()
  {
      ...
      $this->addColumn('product_sku', array(
          'header'    => Mage::helper('banner')->__('Product SKU'),
          'align'     =>'left',
	  'width'     => '150px',
          'index'     => 'product_sku',
      ));
	  ...
	  */
      $this->addColumn('product_image', array(
          'header'    => Mage::helper('banner')->__('Product Image'),
          'align'     =>'left',
	  'width'     => '200px',
          'index'     => 'product_image',
	  'renderer' => 'Webskitters_Banner_Block_Adminhtml_Banner_Grid_Renderer_Image'
      ));
