<?php
//require_once "Mage/Adminhtml/Block/Sales/Order/View.php";
class Webskitters_Creditsave_Block_Adminhtml_View extends Mage_Adminhtml_Block_Widget_Form_Container
{
	...
	public function __construct()
    {
		...
		$deleteccsaveurl = Mage::helper("adminhtml")->getUrl("adminhtml/sales_order/deleteccsave/",array("order_id"=>$this->getRequest()->getParam('order_id')));
		
		 $message = Mage::helper('sales')->__('Are you sure you want to clear payment information for this order?');
            $this->addButton('delete_ccsave', array(
                'label'     => Mage::helper('sales')->__('Wipe'),
                'onclick'   => "confirmSetLocation('{$message}', '{$deleteccsaveurl}')",
