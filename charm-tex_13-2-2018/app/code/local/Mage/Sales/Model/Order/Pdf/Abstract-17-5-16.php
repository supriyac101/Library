...
abstract class Mage_Sales_Model_Order_Pdf_Abstract extends Varien_Object
{
    ...
    protected function insertOrder(&$page, $obj, $putOrderId = true)
    {
        ...
        if($couponCode){
            $page->drawText("COUPON CODE APPLIED FOR FREE SHIPPING: ", 35, $yPayments -= 15, 'UTF-8');
            $this->_setFontRegular($page, 30);
            $page->setFillColor(new Zend_Pdf_Color_Html('#FF0000'))->drawText($couponCode, 265, $yPayments -= 0, 'UTF-8');
